...
High-trial-count rerun of `fig2_emp7_TEST_efficiency_side_by_side.py`, saved to a SEPARATE .png (the
...
fig.suptitle(f'TEST FIGURE: efficiency, side by side, high trial count (N={n_trials}/point)', y=0.99, fontsize=14.5)
...
fig.savefig(perf_dir + 'fig2_emp7_TEST_efficiency_side_by_side_highN.png', dpi=200)
plt.close(fig)
print(f"\nSaved {perf_dir}fig2_emp7_TEST_efficiency_side_by_side_highN.png")
